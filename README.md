...
- "Explique o conceito de X de forma simples"
- "Compare X e Y com exemplos práticos"
- "Quais são os erros comuns ao aplicar X?"
...
> [Resumo estruturado do conteúdo estudado]
...
Este repositório demonstra não apenas o resultado final, mas todo o processo de aprendizado, exploração e refinamento com IA.
``
